...
extension LessonPerformancesViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let studenLessonRecordViewModel = self.viewModel.studentLessonRecordsViewModel.value[tableView.tag]
        ...
        case LessonPerformancesTitles.homeworkStatus.rawValue:
            ...
            cell.buttonCheckHomework
                .addTarget(self, action: #selector(buttonStatusChanged(sender:)), for: .touchUpInside)
        ...
        default:
            ...
            if let count = viewModel.studentLessonRecord.images?.count, count != indexPath.row {
                ...
                cell.buttonDeleteImage
                    .addTarget(self, action: #selector(deleteButtonTapped(sender:)), for: .touchUpInside)
